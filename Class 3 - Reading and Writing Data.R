...
input_csv.df <- read.csv("C:\\YYYY\\AMMA 2017\\Data\\binary.csv",header = T)
...
## Reading Date Values
input_wthdt.df <- read.csv("C:\\YYYY\\AMMA 2017\\Data\\binary_withdate.csv")
str(input_wthdt.df)
...
# read Date as Factor
input_wthdt.df <- read.csv("C:\\YYYY\\AMMA 2017\\Data\\binary_withdate.csv", stringsAsFactors = F)
str(input_wthdt.df)
...
input_tabdlmtd.df <- read.table(file="C:\\YYYY\\AMMA 2017\\Data\\tab_delimited_data.txt",
                                header = TRUE, 
                                sep = '\t')
...
bank_ins = read.sas7bdat("C:\\YYYY\\AMMA 2017\\Data\\bank_additional_full.sas7bdat")
names(bank_ins)
...
# Read SPSS file
spss <- data.frame(read.spss("C:\\YYYY\\AMMA 2017\\Data\\p004.sav"))
...
accessToken <-"EAACEdEose0cBAK03T06IIUlqivYj70dHjSeAZBYyQ6dUEpsDilMZBTcw1eDmco2hRMaqKqInmIIdbqptxhCOolEmZALzu3Peu1Lmf0ZA82GSxDN70di9zUr95ZAro8YUqUT6ZALFmwwBkey8TKRMKHgDQ0N8ZAUpxUUjoiYmEHOL079uZBTsQfHLZB1jMh3guQZBUZD"
...
ssPage <-getPage(page="shoppersstopindia",
                 token=accessToken,
                 n=10)
